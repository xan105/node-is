...
function shouldBoolean(value, error = null){
  if (check.isBoolean(value) === false) {
    if(typeof value === "object" && Object.prototype.toString.call(value) === "[object Boolean]"){
      throw new Failure("new Boolean() is confusing, dangerous, and wasteful. Avoid it", { code: "ERR_USAGE_NOT_RECOMMENDED", info: { 
        type: typeof value, 
        tag: Object.prototype.toString.call(value), 
        value 
      }});
    }
    throw asError(error) ?? new Failure(asString(error) ?? "Expected boolean !", { code: 1, info: { 
      type: typeof value, 
      tag: Object.prototype.toString.call(value), 
      value
    }}); 

...
function shouldObjWithinObj(value, error = null){
  ...
  throw asError(error) ?? new Failure(asString(error) ?? "Expected \"plain obj\" ({}, new Object(), Object.create(null)) assigned as property within another", { code: 1, info: { type: typeof value, value: value } });
}

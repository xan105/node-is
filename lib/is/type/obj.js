  ...
  const test = (fn, ctx, args = []) => {
    try{
      ...
      if (err instanceof Failure)
        throw new Failure(`Schema test function [${fn.name}()] failed !`, { code: 0, cause: err, show: true })
      return false;
    }
  };

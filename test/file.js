...
import { is64bit, is32bit } from "../lib/is/file/binary.js";
import { isPNG, isJPG, isICO } from "../lib/is/file/image.js";
...
t.throws(function(){ isPNG(readFile(join(__dirname,"./sample/blank.txt"),"utf8")) }, {code: "ERR_NOT_A_BUFFER"}, "not a buffer");
t.throws(function(){ isJPG(readFile(join(__dirname,"./sample/blank.txt"),"utf8")) }, {code: "ERR_NOT_A_BUFFER"}, "not a buffer");
t.throws(function(){ isICO(readFile(join(__dirname,"./sample/blank.txt"),"utf8")) }, {code: "ERR_NOT_A_BUFFER"}, "not a buffer");

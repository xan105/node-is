...
t.notOk(check.isObjWithinObj({}), "isObjWithinObj()");
...
t.throws(function(){ assert.shouldObjWithinObj({}) }, "shouldObjWithinObj()");
...
t.equal(opt.asObjWithinObj({}), null, "asObjWithinObj()");

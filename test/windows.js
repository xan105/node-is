...
if (check.isWindows())
{
  if (check.isWin11()) 
  {
    ...
    t.ok(check.isWin11orGreater(), "winver");
    ...
    t.notOk(check.isWin10orLesser(), "winver");
    t.notOk(check.isWin8orLesser(), "winver");
    t.notOk(check.isWin7orLesser(), "winver");
    t.ok(check.isWin11(), "winver");
    t.notOk(check.isWin10(), "winver");
    t.notOk(check.isWin8(), "winver");
    t.notOk(check.isWin7(), "winver");
    
    //assert
    t.doesNotThrow(function(){ assert.shouldWin11orGreater() }, "winver");
    ...
    t.throws(function(){ assert.shouldWin10orLesser() }, "winver");
    t.throws(function(){ assert.shouldWin8orLesser() }, "winver");
    t.throws(function(){ assert.shouldWin7orLesser() }, "winver");
    t.doesNotThrow(function(){ assert.shouldWin11() }, "winver");
    t.throws(function(){ assert.shouldWin10() }, "winver");
